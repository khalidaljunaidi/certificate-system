    ...
    <form action={formAction} className="space-y-4">
      ...
      <div className="rounded-[22px] border border-[rgba(49,19,71,0.12)] bg-[rgba(49,19,71,0.04)] px-4 py-4">
        ...
        <p className="mt-2 text-sm leading-7 text-[var(--color-muted)]">
          ...
          Project Manager for the selected project, and one goes to the Head of
          Projects. Fallback routing applies only if one of these entity-level
          recipients cannot be resolved.
        </p>
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <span className="inline-flex rounded-full bg-white px-3 py-1 text-xs font-semibold text-[var(--color-primary)]">
            Head of Projects: {HEAD_OF_PROJECTS_EMAIL}
          </span>
        </div>
      </div>
